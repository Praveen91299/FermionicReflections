...
if __name__ == "__main__":
    ...
    for i, kind in enumerate(kinds):
        ...
        print('\n\nPolynomial = ', kind)
        fr = FermionicReflection(n_qubits, p, V_type="joint", excitation_type='restricted', qubit_pairs=qubit_pairs)
        fr.optimize_grad(Hs, hf_wfn, init_param_type='random', parallel=True)
        R_list.append(fr)
